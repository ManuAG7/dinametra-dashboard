        ...
        >
          ...
          <div className="flex flex-col gap-2 z-10 flex-1">
            ...
            <p
              ...
              style={{ color: "#94a3b8" }}
            >
              Obtenga acceso anticipado a nuevos lanzamientos y consejos
              restaurativos exclusivos.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row items-center justify-center z-10 w-full lg:w-auto gap-3">
            <div
            ...
            <button
              ...
              className="flex items-center justify-center font-bold text-sm outline-none focus:outline-none focus:ring-0 w-full sm:w-auto"
              style={{
                width: undefined,
                minWidth: 151,
                height: 52,
